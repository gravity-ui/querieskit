...
export type PathEditorProps = {
    ...
    errorMessage?: string;
    /**
     * Called with the current input path (debounced). Return suggestions to let
     * PathEditor manage them, or update the `suggestions` prop instead.
     */
...
export const PathEditor: FC<PathEditorProps> = ({
    ...
    useEffect(() => {
        ...
        // Load suggestions for the initial path only.
